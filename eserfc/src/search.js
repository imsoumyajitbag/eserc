            ...
            if (!querySnapshot.empty) {
                    ...
                    resultHTML += `
                        <div id="successMessage" class="result-item">
                            ...
                            <div class="details">
                                ...
                                <button onclick="window.location.href='public/contribute.html'">Suggest an Edit</button>
                            </div>
                        </div>
                    `;
                ...
                resultContainer.innerHTML = `
                    <div id="errorMessage">
                        ...
                        <button onclick="window.location.href='public/contribute.html'">Suggest to Add</button>
                    </div>
                `;
            }
        } else {
